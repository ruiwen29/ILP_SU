...
/** Generate the type of classes with <istruct ILP_Class ILP_object_Vector_class = {
...
#define ILP_Boolean2ILP(b) \
  ILP_make_boolean(b) struct ILP_Object
...
/** String */struct ILP_Class ILP_object_Vector_class = {
	     &ILP_object_Class_class,
	     { { &ILP_object_Object_class,
	         "Class",
	         1,
...
#define ILP_Modulo(o1,o2) \struct ILP_Class ILP_object_Vector_class = {
&ILP_object_Class_class,
{ { &ILP_object_Object_class,
    "Class",
    1,
