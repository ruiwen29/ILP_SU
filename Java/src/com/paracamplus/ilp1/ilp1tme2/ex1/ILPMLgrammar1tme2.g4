 ...
 */
expr returns [com.paracamplus.ilp1.interfaces.IASTexpression node]//ce noeud sera appelé a chaque expression a evaluer
...
// constantes
    | 'true' # ConstTrue //enterConstTrue et exitConstTrue 
    | 'false' # ConstFalse
