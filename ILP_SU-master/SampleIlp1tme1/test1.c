...
{ 
  ILP_Object ilptmp16; 
ilptmp16 =  ILP_String2ILP("discriminant negatif　: aucune racine"); 
...
{ 
  ILP_Object ilptmp20; 
ilptmp20 =  ILP_String2ILP("discriminant positif : deux racines"); 
...
{ 
  ILP_Object ilptmp21; 
ilptmp21 =  ILP_String2ILP("discriminant nul : une seule racine"); 
